...
class Agent:
    ...
    def train(self, num_updates, policy_freq = 2):
        ...
        for it in range(num_updates):
            ...
            with torch.no_grad():
                target_q1, target_q2 = self.critic_target(next_inputs, self.actor_target(next_inputs))
            ...
            current_q1, current_q2 = self.critic(inputs, actions)
            critic_loss = F.mse_loss(current_q1, target_returns) + F.mse_loss(current_q2, target_returns)
            ...
            if it % policy_freq == 0:
                ...
                # Compute actor loss
                actor_loss = -self.critic.Q1(inputs, self.actor(inputs)).mean()
        ...
        return actor_loss, critic_loss, cycle_actor_loss, cycle_critic_loss
